#
# Be sure to run `pod lib lint JVColorBlender.podspec' to ensure this is a
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'JVColorBlender/Classes/**/*'
  
  # s.resource_bundles = {
  #   'JVColorBlender' => ['JVColorBlender/Assets/*.png']
  # }

  # s.public_header_files = 'Pod/Classes/**/*.h'
  # s.frameworks = 'UIKit', 'MapKit'
  # s.dependency 'AFNetworking', '~> 2.3'
s.dependency 'JVRandomNumberGenerator'
